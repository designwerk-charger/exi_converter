...
TEST_F(ComplexTypesTest, DecodeComplexCombination_MessageHeaderType) {
    /* Data extracted from OpenV2G
     * Start iso header
...
TEST_F(ComplexTypesTest, DecodeOptionalElements_DC_EVChargeParameterType) {
    ...
    complex_types->decode_DC_EVChargeParameterType();
